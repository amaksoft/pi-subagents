...
- **`/resume-filtered`** — now a separate plugin: [`pi-resume-filtered`](https://github.com/amaksoft/pi-resume-filtered) (framework-agnostic collapsible resume tree). Install it alongside for navigable session resume with children collapsed by default
